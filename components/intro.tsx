...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      <div>
        <motion.h1
          className="mb-10 mt-4 px-3.5 text-2xl font-medium !leading-[1.5] sm:text-2xl"
          initial={{ opacity: 0, y: 100 }}
          animate={{ opacity: 1, y: 0 }}
        >
          <span className="font-bold">Hi there! I&apos;m Yushan.</span> I am a{" "}
          <span className="font-bold">full-stack developer</span> and currently
        ...
        >
          ...
          >
            Contact me here
            <BsArrowRight
              className="opacity-70 group-hover:translate-x-1.5 transition"
              onClick={() => {
          ...
          <a
            ...
            active:scale-105 transition cursor-pointer border border-black/20 dark:bg-white/10 dark:text-white/60"
            href="/CV.pdf"
            download
          >
            Download CV
